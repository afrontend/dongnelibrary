...
- [연수구립도서관][yeonsu-url] — 21개 도서관 (연수청학, 송도국제, 송도국제어린이, 연수꿈담, 해돋이, 선학별빛, 함박비류, 동춘나래, 작은도서관 9개, 스마트도서관 4개)
...
- [서대문구립도서관][sdm-url] — 21개 도서관 (이진아기념, 새롬어린이, 홍은도담, 해담는, 알음알음·하늘샘·북아현 마을북카페·늘푸른 열린·아이누리·파랑새·논골·새싹·행복·꿈이있는·문화촌·햇살·폭포책방아름인 작은도서관, 구청·아현역·홍제역·독립문역 스마트도서관)
- [세종시립도서관][sejong-url] — 24개 도서관 (시립, 도담동, 아름동, 종촌동, 한솔동, 고운동, 보람동, 대평동, 새롬동, 고운남측, 소담동, 다정동, 조치원어린이, 해밀동, 반곡동, 조치원읍, 새롬싱싱, 나성동, 전의나무, 어진그림책, 전의면·소정면·장군면·연동면 작은도서관)
...
### 테스트
    ...
    npm run sdm     # 서대문구 도서관
    npm run sejong  # 세종시립 도서관
    ...
    npm run jeonju  # 전주시립 도서관
    npm run wonju   # 원주시 도서관
    npm run yslib   # 여수시 도서관
    npm run yuseong # 유성구 도서관
...
[jeonju-url]: https://lib.jeonju.go.kr
...
[yeonsu-url]: https://yspubliclib.go.kr
...
[sdm-url]: https://lib.sdm.or.kr
[sejong-url]: https://lib.sejong.go.kr